...
def get_player_stats_with_real_check(player_name):
    ...
    real_player_info = real_players.get(player_key)
    ...
    if response.status_code == 200:
        ...
        display_player_stats(player_data, real_player_info is not None)
...
def generate_player_data(player_name, real_player_info=None):
    ...
    if real_player_info:
        ...
        teams = ["ANA", "ARI", "BOS", "BUF", "CGY", "CAR", "CHI", "COL", "CBJ", "DAL", "DET", "EDM", "FLA", "LAK",
