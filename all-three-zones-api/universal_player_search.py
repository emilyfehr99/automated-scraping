...
Automatically finds and adds ANY player you search for!
"""
...
def get_any_player(player_name: str) -> Dict[str, Any]:
    """Get ANY player - auto-adds if not found"""
    ...
    try:
        ...
        if response.status_code == 200:
            print(f"✅ Found {player_name} in database!")
...
def main():
    """Main function - universal player search"""
    print("🏒 UNIVERSAL NHL PLAYER SEARCH")
    print("=" * 50)
    print("Search for ANY player - they'll be auto-added if not found!")
    ...
    while True:
        try:
            ...
            player_data = get_any_player(player_name)
