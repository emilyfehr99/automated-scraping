#!/usr/bin/env python3
"""
Fixed Advanced NHL Analytics with Player Stats and xG Model
Correctly extracts player statistics from play-by-play data and builds Expected Goals model
"""
...
class FixedAdvancedNHLAnalytics:
    def __init__(self):
        ...
        for play in plays:
            ...
            if play_type == 'goal':
                ...
                if assist1_player_id:
                    ...
                    player_stats[assist1_player_id]['assists_given'].append({
                        'period': period,
                        'time': time_remaining
                    })
                ...
                if assist2_player_id:
                    ...
                    player_stats[assist2_player_id]['assists_given'].append({
                        'period': period,
                        'time': time_remaining
                    })
...
def main():
    """Test the fixed advanced analytics system"""
    print("🏒 FIXED ADVANCED NHL ANALYTICS WITH PLAYER STATS & xG MODEL 🏒")
    print("=" * 70)
    
    analytics = FixedAdvancedNHLAnalytics()
    ...
    if play_by_play_data:
        ...
        if player_stats:
            ...
            print("\n🎉 Fixed advanced analytics system working perfectly!")
